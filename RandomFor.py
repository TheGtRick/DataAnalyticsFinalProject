...
# Creating model here is Random Forest
...
y_test.to_csv('C:\\Users\\Rakon\\Desktop\\Final Project\\Y-testR.csv', index=False)
y_pred.to_csv('C:\\Users\\Rakon\\Desktop\\Final Project\\Y-predR.csv', index=False)